...
namespace testproject01
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            using (var context = new MyDbContext())
            {
                ...
                Console.WriteLine("All Data Updated");
            }
        ...
        {
            Console.WriteLine("Trying to login to the API...");
    ...
    public class MyDbContext : DbContext
    {
        ...
        public DbSet<WellDto> Well { get; set; }
    ...
    public class PlatformDto
    {
        ...
        public List<WellDto> well { get; set; } // Navigation property for related wells
